 ...
 # airqualityLocal_month$`5`$Temp
  print ("***************************************")
  
  ## Access it by month as we had split by month
  airqualityLocal_month_5 <- airqualityLocal_month$`5`
  airqualityLocal_month_5$Temp
    
   # dim(airqualityLocal_month$`5`)
    #str(airqualityLocal_month[[i]])
  #  airqualityLocal_month[[1]][2,]
 
    
 
 
  
  print ("_____--------------------------________________--------_____________")
  ...
  airqualityLocal_month[[6]][1,]
  nrow(airqualityLocal_month[[6]])
